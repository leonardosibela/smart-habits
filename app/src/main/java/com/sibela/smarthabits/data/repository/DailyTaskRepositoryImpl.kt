...
class DailyTaskRepositoryImpl(private val dailyTaskDao: DailyTaskDao) : DailyTaskRepository {
    ...
    override suspend fun remove(dailyTask: DailyTask) = dailyTaskDao.delete(dailyTask)
}