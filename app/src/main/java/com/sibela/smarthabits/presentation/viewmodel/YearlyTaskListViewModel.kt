...
import com.sibela.smarthabits.domain.usecase.GetTasksThatAreYearlyUseCase
import com.sibela.smarthabits.extension.asLiveData
import kotlinx.coroutines.launch

class YearlyTaskListViewModel(
    private val getTasksThatAreYearlyUseCase: GetTasksThatAreYearlyUseCase,
    ...
    init {
        viewModelScope.launch {
            val result = getTasksThatAreYearlyUseCase()
