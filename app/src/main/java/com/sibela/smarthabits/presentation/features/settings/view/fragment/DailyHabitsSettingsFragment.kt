...
import com.sibela.smarthabits.presentation.constants.AnimationConstants.DELAY_BEFORE_SHOWING_FAB
import com.sibela.smarthabits.presentation.features.settings.view.dialog.HabitDeletionDialog
...
class DailyHabitsSettingsFragment : Fragment() {
    ...
    private val viewModel: DailyHabitsSettingsViewModel by viewModel()
