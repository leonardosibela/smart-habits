...
class DeleteHabitUseCaseTest {
    ...
    fun deleteDailyHabit() = runTest {
        ...
        coVerify(exactly = 1) {
            dailyHabitRepository.removeNotCompletedByDescription(habit.description)
        }
    }
    ...
    fun deleteWeeklyHabit() = runTest {
        ...
        coVerify(exactly = 1) { habitRepository.delete(habit) }
        coVerify(exactly = 1) {
            weeklyHabitRepository.removeNotCompletedByDescription(habit.description)
        }
    }
    ...
    fun deleteMonthlyHabit() = runTest {
        ...
        coVerify(exactly = 1) { habitRepository.delete(habit) }
        coVerify(exactly = 1) {
            monthlyHabitRepository.removeNotCompletedByDescription(habit.description)
        }
    }
    ...
    fun deleteYearlyHabit() = runTest {
        ...
        coVerify(exactly = 1) { habitRepository.delete(habit) }
        coVerify(exactly = 1) {
            yearlyHabitRepository.removeNotCompletedByDescription(habit.description)
        }
    }
}
